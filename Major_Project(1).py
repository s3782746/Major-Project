...
# Create Canvas
canvas_1 = Canvas( root, width = 853,
                 height = 625)
  
canvas_1.pack(fill = "both", expand = True)
  
# Display image
canvas_1.create_image( 0, 0, image = bg, 
                     anchor = "nw")

canvas_1.create_text( 350, 50, text = "The Best Coffee in Melbourne CBD", font=('Helvetica','24','bold'))
...
# Display Buttons
button1_canvas = canvas_1.create_window( 120, 300, window = button1)
  
button2_canvas = canvas_1.create_window( 400, 490, window = button2)
  
button3_canvas = canvas_1.create_window( 180, 570, window = button3)
                        
button4_canvas = canvas_1.create_window( 660, 100, window = button4)

button5_canvas = canvas_1.create_window( 750, 250, window = button5)

button6_canvas = canvas_1.create_window( 600, 220, window = button6)

button7_canvas = canvas_1.create_window( 200, 380, window = button7)

button8_canvas = canvas_1.create_window( 380, 350, window = button8)

button9_canvas = canvas_1.create_window( 450, 200, window = button9)

button10_canvas = canvas_1.create_window( 600, 400, window = button10)
